...
function AddAllItemsToTable(TheStudent) {
    ...
    TheStudent.forEach(element => {
        AddItemToTable(element.H_Date + "-" + element.G_Time, element.A_Name, element.B_Address, element.C_Phone, element.D_Email, element.E_Service, element.J_Price, element.F_Barber, element.I_QR);
    });
}
